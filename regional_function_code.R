...
TrustCodesRegex <- TrustCodes %>% filter(RegionCode == "Y62") %>% pull(TrustCode) %>% paste0(collapse = "', '")
TrustCodesRegex_00 <- TrustCodes %>% filter(RegionCode == "Y62") %>% pull(TrustCode) %>% paste0("00", collapse = "', '")
